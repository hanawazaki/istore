<template>
  <div class="default flex flex-row justify-between bg-[#EDEDED]">
    <!-- sidebar -->
    <button
    ...
    <aside
      id="logo-sidebar"
      class="fixed top-0 left-0 z-40 ml-4 rounded-xl h-screen transition-transform -translate-x-full sm:translate-x-0"
