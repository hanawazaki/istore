<template>
  ...
  <div class="default flex flex-row justify-between">
    <!-- sidebar -->
    <aside
      id="logo-sidebar"
      class="fixed hidden sm:block top-0 left-0 z-40 ml-4 rounded-xl h-screen transition-transform -translate-x-full sm:translate-x-0"
      :class="extendSidebar ? 'w-[162px]' : 'w-[72px]'"
      aria-label="Sidebar"
    >
      <div
        class="h-full rounded-lg p-2 overflow-hidden bg-white dark:bg-gray-800"
      >
        <div
          class="flex flex-col gap-8 p-2"
          :class="extendSidebar ? 'barActive' : ''"
        >
          <RouterLink to="/" class="px-2 border-black">
            <img
              src="../assets/icons/logo.png"
              class="h-6 sm:h-7"
              :class="extendSidebar ? 'mr-auto' : 'mx-auto'"
              alt="Flowbite Logo"
            />
          </RouterLink>
          <a href="#" class="px-2" @click="handleSideBar">
            <img
          ...
          <RouterLink to="/" class="p-2 menu" :class="{ active: isActive }">
            <div class="flex justify-start items-center">
              <svg
                class="h-6 sm:h-7"
                :class="extendSidebar ? 'mr-4' : 'mx-auto'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              >
                <path
                  ...
                  :fill="isActive1 ? '#fff' : '#1A1F16'"
                />
              </svg>
              <label
                class="text-xl font-normal"
                :class="[
                  isActive1 ? 'text-white' : 'text-[#1A1F16]',
                  extendSidebar ? 'block' : 'hidden',
                ]"
                >Store</label
              >
            </div>
          ...
          >
            <div class="flex justify-start items-center">
              ...
              >
                <path
                  d="M21.3117 8.64978C21.1727 8.50976 21.0073 8.39871 20.825 8.32308C20.6428 8.24744 20.4473 8.20872 20.25 8.20915H17.25V7.45915C17.25 6.06677 16.6969 4.73141 15.7123 3.74684C14.7277 2.76228 13.3924 2.20915 12 2.20915C10.6076 2.20915 9.27226 2.76228 8.28769 3.74684C7.30312 4.73141 6.75 6.06677 6.75 7.45915V8.20915H3.75C3.35218 8.20915 2.97064 8.36719 2.68934 8.64849C2.40804 8.9298 2.25 9.31133 2.25 9.70915V19.8342C2.25 21.6623 3.79688 23.2092 5.625 23.2092H18.375C19.2593 23.2094 20.1086 22.8637 20.7413 22.2459C21.0596 21.9421 21.3132 21.577 21.4865 21.1726C21.6599 20.7682 21.7495 20.3328 21.75 19.8927V9.70915C21.7506 9.51236 21.7122 9.31741 21.637 9.13557C21.5617 8.95373 21.4512 8.78861 21.3117 8.64978ZM8.25 7.45915C8.25 6.46459 8.64509 5.51076 9.34835 4.8075C10.0516 4.10424 11.0054 3.70915 12 3.70915C12.9946 3.70915 13.9484 4.10424 14.6517 4.8075C15.3549 5.51076 15.75 6.46459 15.75 7.45915V8.20915H8.25V7.45915ZM17.25 11.9592C17.25 13.3515 16.6969 14.6869 15.7123 15.6715C14.7277 16.656 13.3924 17.2092 12 17.2092C10.6076 17.2092 9.27226 16.656 8.28769 15.6715C7.30312 14.6869 6.75 13.3515 6.75 11.9592V11.2092C6.75 11.0102 6.82902 10.8195 6.96967 10.6788C7.11032 10.5382 7.30109 10.4592 7.5 10.4592C7.69891 10.4592 7.88968 10.5382 8.03033 10.6788C8.17098 10.8195 8.25 11.0102 8.25 11.2092V11.9592C8.25 12.9537 8.64509 13.9075 9.34835 14.6108C10.0516 15.3141 11.0054 15.7092 12 15.7092C12.9946 15.7092 13.9484 15.3141 14.6517 14.6108C15.3549 13.9075 15.75 12.9537 15.75 11.9592V11.2092C15.75 11.0102 15.829 10.8195 15.9697 10.6788C16.1103 10.5382 16.3011 10.4592 16.5 10.4592C16.6989 10.4592 16.8897 10.5382 17.0303 10.6788C17.171 10.8195 17.25 11.0102 17.25 11.2092V11.9592Z"
                  :fill="isActive2 ? '#fff' : '#1A1F16'"
                />
              </svg>
              ...
              <label
                class="text-xl font-normal"
                :class="[
                  isActive2 ? 'text-white' : 'text-[#1A1F16]',
                  extendSidebar ? 'block' : 'hidden',
                ]"
                >Bag</label
              >
    ...
    <!-- bag -->
    <div
      class="bag w-[345px] border-l-4 border-[#1A1F1680] min-h-screen hidden xl:block"
    >
...
const handleSideBar = () => {
  extendSidebar.value = !extendSidebar.value;
};
</script>

<style>
@import url("https://fonts.googleapis.com/css2?family=Cabin:wght@400;500;600&family=Inter:wght@300;400;500;600;700;800&display=swap");
.default {
